...
server {
    ...
    #server_name explorer.vulcanocrypto.com;
    server_name _;
    ...
    #ssl_certificate /etc/letsencrypt/live/explorer.vulcanocrypto.com/fullchain.pem; # managed by Certbot
    #ssl_certificate_key /etc/letsencrypt/live/explorer.vulcanocrypto.com/privkey.pem; # managed by Certbot
    #include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    #ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

#server {
#    if ($host = explorer.vulcanocrypto.com) {
...
installVulcano () {
    ...
    cd
    rm -rf /tmp/vulcano
    mkdir -p /home/explorer/.vulcano
    cat > /home/explorer/.vulcano/vulcano.conf << EOL
rpcport=52544
rpcuser=$rpcuser
...
[Unit]
Description=vulcanod
After=network.target
[Service]
Type=forking
User=explorer
WorkingDirectory=/home/explorer
ExecStart=/home/explorer/bin/vulcanod -datadir=/home/explorer/.vulcano
ExecStop=/home/explorer/bin/vulcano-cli -datadir=/home/explorer/.vulcano stop
Restart=on-abort
[Install]
...
installBlockEx () {
    ...
    git clone https://github.com/vulcano-crypto/vulcano-explorer.git /home/explorer/blockex
